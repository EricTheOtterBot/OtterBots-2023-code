...
public class AutoOnePieceNoBacking extends SequentialCommandGroup {
    public AutoOnePieceNoBacking(Swerve s_Swerve, Lift s_ClawLift, Claw s_Claw, Timer m_timer){
