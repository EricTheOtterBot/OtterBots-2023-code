...
public class AutoHighCubeR extends SequentialCommandGroup {
    public AutoHighCubeR(LimelightVision s_Limelight, Swerve s_Swerve, Claw s_Claw, Lift s_Lift, Timer m_timer){
        ...
        Command retractcommand2 = new EricAutoExtend(s_Lift, 1, false, false, 1, m_timer);
        ...
        Command retractandlowercommand3 = new EricAutoRetractAndLower(s_Lift, 1, -1, true, false, false, 1, m_timer);
